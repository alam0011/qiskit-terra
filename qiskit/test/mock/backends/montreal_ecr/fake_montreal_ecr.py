...
"""
Fake Montreal device (27 qubit) with ECR gates.
"""
...
class FakeMontrealECR(FakeBackend):
    ...
    def properties(self):
        ...
        if not self._properties:
            dirname = os.path.dirname(__file__)
            filename = "props_montreal_ecr.json"
    ...
    def defaults(self):
        ...
        if not self._defaults:
            dirname = os.path.dirname(__file__)
            filename = "defs_montreal_ecr.json"
